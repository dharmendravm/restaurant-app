      ...
      <div className="bg-[rgba(255,255,255,0.02)] border border-white/6 backdrop-blur-xl rounded-2xl p-5 px-6 flex flex-col justify-between shadow-[0_10px_40px_rgba(0,0,0,0.6)]">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-2 max-w-lg">
            Join <span className="text-orange-200 font-bold">TableOrbit</span> &
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-amber-300 hover:bg-orange-500 border hover:border-amber-500 text-black font-semibold 
                py-2.5 rounded-lg shadow-lg shadow-orange-500/20 transition delay-150 duration-300 ease-in-out active:scale-95 
